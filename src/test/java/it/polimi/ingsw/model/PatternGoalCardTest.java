...
public class PatternGoalCardTest {
    ...
    /**
     * Checks if the points for reaching a goal are correctly calculated.
     */
     @Test
    ...
    /**
     * Check the checkGoal method by controlling it doesn't count twice the same card in a pattern.
     */
    @Test
    ...
    /**
     * Check the checkGoal method by controlling its pattern occurrences counting.
     */
    @Test
    public void checkGoal_correctly_count_occurences(){
        Pawn r = null;
        Corner[] corners = new Corner[4];
        for(int x=0; x<4; x++){
            corners[x]= new Corner(x, null);
    ...
    /**
     * Check the checkGoal method by controlling it doesn't count points in case of "reverse" diagonal card pattern.
     */
    @Test
