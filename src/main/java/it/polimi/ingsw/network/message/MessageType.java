...
public enum MessageType {
    ...
    WINNER, REPLY_CHOICES_MADE, REPLY_YOUR_TURN, NOTIFY_END_GAME, REQUEST_INTERRUPT_GAME, REPLY_INTERRUPT_GAME, REQUEST_VIEWABLE_CARDS, REPLY_VIEWABLE_CARDS, NEW_CHAT_MESSAGE, REPLY_CHAT_MESSAGE,
}
