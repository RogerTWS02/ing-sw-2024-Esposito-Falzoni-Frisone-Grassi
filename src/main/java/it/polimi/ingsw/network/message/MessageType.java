...
public enum MessageType {
    ...
    WINNER, NOTIFY_GAME_STARTING, REPLY_CHOICES_MADE, REPLY_YOUR_TURN, NOTIFY_END_GAME, REQUEST_INTERRUPT_GAME, REPLY_INTERRUPT_GAME, REQUEST_VIEWABLE_CARDS, REPLY_VIEWABLE_CARDS, NEW_CHAT_MESSAGE, REPLY_CHAT_MESSAGE, TEST_END_GAME, REQUEST_AVAILABLE_LOBBIES, REQUEST_PLAYER_BOARD, REQUEST_PLAYER_BOARD_INFOS, REPLY_PLAYER_BOARD_INFOS, REPLY_PLAYER_BOARD, REPLY_AVAILABLE_LOBBIES
}
